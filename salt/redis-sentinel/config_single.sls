...
{# Run only port defined! #}
{# Compare defined port matched with port in pillar or not! #}
{% if redis.port == instance.redisPort %}

{# Install redis on defined node only #}
...
{# End of Install redis on defined node only! #}
{% endif %}
...
{# endif of Run only port defined #}
{% endif %}


{# endfor of loop instances #}
{% endfor %}
